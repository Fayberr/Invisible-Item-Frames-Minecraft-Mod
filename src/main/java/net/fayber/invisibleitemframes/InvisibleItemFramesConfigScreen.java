...
// hand-rolled ModMenu config screen, used when Cloth Config isn't installed.
// every control writes through InvisibleItemFramesConfig.set(), which
// updates the in-memory config and saves it to disk
