...
// same pattern as the rest of the client package - a dedicated
// server never executes this class. Callers: SignInteractionHandler
// (client branch of onUseBlock) and ItemFrameInteractionHandler
// (client branch of onUseEntity) - both guard the call with
// level.isClientSide().
